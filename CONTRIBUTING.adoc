...
git clone https://github.com/hyperpolymath/TradeUnionism.jl.git cd
TradeUnionism.jl
...
toolbox create TradeUnionism.jl-dev toolbox enter TradeUnionism.jl-dev #
...
TradeUnionism.jl/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ #
