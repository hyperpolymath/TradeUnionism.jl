...
All placeholders in this template follow the `+TradeUnionism.jl+`
...
|===
|Placeholder |Description |Example |Files
|`+TradeUnionism.Jl+` |Human-readable project name |`+My Project+`
|SECURITY.md, CODE_OF_CONDUCT.md, TOPOLOGY.md, STATE.a2ml, Justfile,
GOVERNANCE.md, MAINTAINERS.md, flake.guix, devcontainer.json

|`+TradeUnionism.jl+` |One-line description |`+A tool for X+`
|flake.guix

|`+TradeUnionism.jl+` |Uppercase identifier (for Idris2 modules, C
...
|`+TradeUnionism.jl+` |Repository name (slug) |`+my-project+`
...
|`+TradeUnionism.jl+` |One-line project description
