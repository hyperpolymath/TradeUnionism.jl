...
//
// Proof Progress Snapshot — TradeUnionism.jl
// Generated: 2026-08-14

= TradeUnionism.jl — Proof/Verification Guarantee Progress Snapshot
:toc:
:icons: font

This document provides an indicative state of progress on formal guarantees for
the TradeUnionism.jl Julia package as of 2026-08-14.
